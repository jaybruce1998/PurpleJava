...
public class TrainerStrings
{
	static String[] CATCH_PHRASE_STRINGS="""
Hey, I was trying to catch pokemon!;Ahh okay, I guess you can hang!
...
I'm the last line of defense!;Or at least, I was.""".split("\n");
	static String[] LEADER_SPEECH_STRINGS="""
Sigh... yep, I'm Brock. Let's do this.;Whoa, that was rocking! You earned yourself a badge and a TM, bide!
...
At last, you've found me. Well play time is over, it's time to bring my squad back to life!;Ugh, I've gotten weak... but that was well done! You'll want to fissure the Elite Four... as for me? Goodbye.""".split("\n");
	static String[] GIO_RIVAL_SPEECH_STRINGS="""
Another kid in my lair? You'll be lucky to escape alive!;Blast it... those idiots better be working hard in the tower!
...
Buddy, you got every badge? Heh, I did, too! Let's see what you've got!;Still not enough, eh? I heard a man in Viridian City trains in isolation, maybe he'll train me...""".split("\n");
	static String[] E4_SPEECH_STRINGS="""
Hah, so the gym leaders HAVE gotten weaker! Well this should be interesting, I guess I can use you as warm-up training!;WHAT?! I lost?! Dammit! Alright, go on through, but don't expect to get past the next trainers!
...
Eh-hem! Yes, hello, I am the most elite of the four! My dragons are quite terrifying - I'm surprised you lived through the last three battles, but that ends NOW!;Whoa, you're the real deal! I gotta hand it to you, not many can beat my devilish dragons! Anyway, you did great, you should go home now!... huh? No, there's nothing behind me! Seriously, go home... okay fine, I'll admit it - you're not the champion. I'm not the champion. There is another... sigh, you really want to be the best? Then go through, but don't say I didn't warn you!
Heh... surprised? Yeah "buddy," it's me, Noah. I've gotta say, after training with Jay I'm pretty dissappointed with the "Elite Four!" I mean come on, they were begging for mercy, but I've finally learned how to be strong. I won't hold back anymore - you're going to lose.;WHAT? BUT, but... ugh, fine, you're the champion, okay buddy? Go on in and record your team... and make sure you complete your pokedex! A certain somebody wants to see just how strong you can get...
So you beat Noah... I don't think I can vanquish this abomination by myself, but maybe you can help... Let's see what you've got!;Huh, you're not bad, kid. Maybe you've got what it takes to conquer the void!""".split("\n");
}