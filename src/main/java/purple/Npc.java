...
Route4;COOLTRAINER_F 9 8 DOWN,COOLTRAINER_F 63 3 RIGHT
...
VermilionPokecenter;NURSE 3 1 DOWN,FISHING_GURU 10 5 DOWN,SAILOR 5 4 DOWN,LINK_RECEPTIONIST 11 2 DOWN
...
SafariZoneCenter;GYM_GUIDE 13 23 RIGHT""".split("\n");
	public static void buildNpcs()
	{
		int i=0;
		for(String s: NPC_STRINGS)
		{
			String[] a=s.split(";");
